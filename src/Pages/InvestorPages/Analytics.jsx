...
import { useGetPitchesForInvestorQuery } from "../../features/pitch/pitchApiSlice";
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-8">
            <div className="max-w-6xl mx-auto">
                <h1 className="text-3xl font-bold text-gray-900 mb-8">Investor Analytics</h1>

                {/* Stats Grid */}
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        <h3 className="text-gray-500 text-sm font-medium uppercase">Pitches Received</h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        <h3 className="text-lg font-semibold mb-4">Recent Pitches</h3>
                        <div className="overflow-y-auto max-h-80">
                            {pitches.length === 0 ? (
                                <p className="text-gray-500 text-center py-4">No pitches received yet.</p>
                            ) : (
